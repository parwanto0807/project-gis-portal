        ...
        <div className="space-y-5 sm:space-y-6 pb-20 -mx-3 sm:mx-0 -mt-2 sm:mt-0">
            ...
            <div className="hidden sm:flex justify-between items-start mb-4">
                <div className="flex flex-col gap-1.5">
                    <Badge variant="secondary" className="w-fit px-2.5 py-0.5 bg-slate-100 hover:bg-slate-100 border-slate-200">
                        <Breadcrumb>
                            <BreadcrumbList className="text-[10px] md:text-xs">
                                ...
                                <BreadcrumbSeparator />
                                <BreadcrumbItem>
                                    <BreadcrumbPage className="text-slate-900 font-semibold">Discipline Monitor</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </Badge>
                    <div>
                        ...
                        <p className="text-xs text-slate-500">Professional oversight and discipline tracking.</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href="/admin/hr/discipline/new">
                        <Button size="sm" className="h-8 text-xs px-3 bg-slate-900 hover:bg-slate-800 text-white font-semibold shadow-sm">
                ...
                <Card className="bg-white shadow-sm border border-slate-200">
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between mb-2">
                            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Total Reports</p>
                            <Hash className="w-4 h-4 text-slate-400" />
                        </div>
                        <h4 className="text-2xl font-bold text-slate-900">{reports.length}</h4>
                    </CardContent>
                </Card>
                <Card className="bg-white shadow-sm border border-slate-200">
                    <CardContent className="p-4">
            ...
            <Card className="bg-white shadow-sm border border-slate-200">
                <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 flex bg-slate-50 p-0.5 rounded-lg border border-slate-200 scrollbar-hide">
                ...
                {/* Mobile Cards View */}
                <div className="lg:hidden bg-slate-50/50 p-3 flex flex-col gap-3">
                    <AnimatePresence mode="popLayout">
                        {filteredReports.map((report) => (
                            <motion.div 
                                ...
                                className="bg-white rounded-xl p-3 shadow-sm border border-slate-200 active:scale-[0.98] transition-transform cursor-pointer flex flex-col gap-2"
                            >
                                ...
                                <div className="bg-slate-50 p-2 rounded-lg border border-slate-200">
                                    <div className="flex items-center gap-1.5 mb-1">
                                        ...
                                        <span className="font-semibold text-slate-700 text-[10px]">{report.type.split(' / ')[0]}</span>
                                    </div>
                                    <p className="text-[10px] text-slate-500 line-clamp-2">"{report.description}"</p>
                                </div>
                    ...
                    <Table>
                        <TableHeader className="bg-slate-50 border-b border-slate-200">
                            <TableRow className="hover:bg-transparent">
                                <TableHead className="w-[120px] font-semibold text-slate-500 text-xs h-9 py-2 pl-4">Date</TableHead>
                                <TableHead className="w-[200px] font-semibold text-slate-500 text-xs h-9 py-2">Personnel</TableHead>
                                <TableHead className="font-semibold text-slate-500 text-xs h-9 py-2">Violation</TableHead>
                                <TableHead className="w-[120px] font-semibold text-slate-500 text-xs h-9 py-2">Location</TableHead>
                                <TableHead className="font-semibold text-slate-500 text-xs h-9 py-2">Status / Action</TableHead>
                                <TableHead className="font-semibold text-slate-500 text-xs h-9 py-2">Reporter</TableHead>
                            ...
                            <AnimatePresence mode="popLayout">
                                {filteredReports.map((report) => (
                                    <TableRow key={report.id} className="group hover:bg-slate-50/50 transition-colors">
                                        <TableCell className="pl-4 py-2 font-medium text-slate-600 text-xs">
                                        ...
                                        <TableCell className="py-2">
                                            <div className="flex items-center gap-2">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-slate-500">{report.targetEmployeeId}</span>
                                                </div>
                                            </div>
                                        </TableCell>
                                        <TableCell className="py-2">
                                            <div className="flex flex-col gap-0.5">
                                                <div className="flex items-center gap-1.5">
                                                    <div className={`w-1.5 h-1.5 rounded-full ${severityMap[report.type]?.color || 'bg-slate-300'}`} />
                                                    <span className="font-semibold text-slate-700 text-xs">{report.type.split(' / ')[0]}</span>
                                                    <Badge variant="outline" className={`text-[8px] h-4 px-1 py-0 border-slate-200 ${severityMap[report.type]?.color ? severityMap[report.type]?.color.replace('bg-', 'text-').replace('500', '600') : 'text-slate-500'}`}>
                                        ...
                                        <TableCell className="py-2">
                                            <div className="flex flex-col">
                                                <span className="font-semibold text-slate-700 text-xs">{report.reporter?.firstName} {report.reporter?.lastName}</span>
                                                <span className="text-[9px] text-slate-500">Reporter</span>
                                            </div>
                                        </TableCell>
                                        <TableCell className="text-right pr-4 py-2">
                                            <Button 
                                                variant="ghost" 
                                                size="sm"
                                                className="h-7 px-2.5 text-[10px] font-semibold bg-slate-50 border border-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-900"
                                                onClick={() => handleViewDetail(report)}
                                            >
                                                View
                                            </Button>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-[95vw] sm:max-w-3xl rounded-xl border border-slate-200 shadow-xl p-0 overflow-hidden bg-white">
                    {selectedReport && (
                        <div className="flex flex-col sm:flex-row w-full h-full max-h-[85vh] overflow-y-auto sm:overflow-hidden">
                            {/* Left: Proof Image */}
                            <div className="w-full sm:w-2/5 min-h-[200px] sm:min-h-full bg-slate-100 flex items-center justify-center relative overflow-hidden border-r border-slate-200">
                                ...
                                <div className="absolute top-4 left-4 z-10 flex flex-col gap-1.5">
                                    ...
                                    <Badge className="bg-white/95 backdrop-blur-md text-slate-900 border border-slate-200 shadow-sm font-semibold uppercase text-[9px] px-1.5 py-0">
                                ...
                                <div className="space-y-4 flex-1">
                                    <div className="flex justify-between items-start">
                                        <DialogHeader className="text-left space-y-0.5">
                                            ...
                                            <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Incident Log</p>
                                        </DialogHeader>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 bg-slate-50 border border-slate-200 p-3 rounded-lg">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-xs font-semibold text-slate-900">{selectedReport.location || "N/A"}</p>
                                        </div>
                                        <div className="space-y-0.5">
                                            <Label className="text-[9px] font-semibold text-slate-500 uppercase tracking-wider flex items-center">
                                                <Hash className="w-2.5 h-2.5 mr-1" /> Subject ID
                                            </Label>
                                            <p className="text-xs font-semibold text-slate-900">{selectedReport.targetEmployeeId}</p>
                                        </div>
                                        <div className="space-y-0.5">
                                            <Label className="text-[9px] font-semibold text-slate-500 uppercase tracking-wider flex items-center">
                                                <Calendar className="w-2.5 h-2.5 mr-1" /> Timestamp
                                            </Label>
                                            <p className="text-xs font-semibold text-slate-900">{format(new Date(selectedReport.createdAt), 'MMM dd, yyyy HH:mm')}</p>
                                        </div>
                                        <div className="space-y-0.5">
                                            <Label className="text-[9px] font-semibold text-slate-500 uppercase tracking-wider flex items-center">
                                                <User className="w-2.5 h-2.5 mr-1" /> Reporter
                                            </Label>
                                            <p className="text-xs font-semibold text-slate-900">{selectedReport.reporter?.firstName} {selectedReport.reporter?.lastName}</p>
                                        </div>
                                    </div>

                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-semibold text-slate-600 uppercase tracking-wider flex items-center gap-1.5"><Info className="w-3.5 h-3.5" /> Narrative</Label>
                                    ...
                                    {selectedReport.status === 'PENDING' ? (
                                        <div className="space-y-4 pt-1">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Superior Action</h3>
                                            </div>
                                            
                                            <div className="space-y-3 bg-white p-0">
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    <div className="space-y-1.5">
                                                        <Label className="text-[10px] font-semibold text-slate-600">Select Action</Label>
                                                        <select 
                                                            className="w-full h-8 bg-white border border-slate-200 rounded-md px-2.5 text-xs font-medium focus:ring-1 focus:ring-slate-900 outline-none"
                                                            value={actionTaken}
                                                    ...
                                                    <div className="space-y-1.5">
                                                        <Label className="text-[10px] font-semibold text-slate-600">Action Date</Label>
                                                        <Input 
                                                            type="date" 
                                                            className="h-8 bg-white border-slate-200 rounded-md text-xs px-2.5"
                                                            value={actionDate}
                                                ...
                                                <div className="space-y-1.5">
                                                    <Label className="text-[10px] font-semibold text-slate-600">Resolution Summary / Resume</Label>
                                                    <textarea 
                                                        className="w-full min-h-[60px] bg-white border border-slate-200 rounded-md p-2.5 text-xs focus:ring-1 focus:ring-slate-900 outline-none resize-none"
                                                ...
                                                <div className="space-y-1.5">
                                                    <Label className="text-[10px] font-semibold text-slate-600">Resolution Proof (Photo)</Label>
                                                    <div className="flex items-center gap-3">
                                                        <Button 
                                                            ...
                                                            className="h-8 border-slate-200 rounded-md px-3 text-xs flex items-center gap-2"
                                                        >
                                                            <Camera className="w-3.5 h-3.5 text-slate-500" />
                                                            {resolutionPhoto ? 'Change Proof' : 'Upload Proof'}
                                                        </Button>
                                                        {resolutionPhoto && (
                                                            <div className="w-12 h-8 rounded-md overflow-hidden border border-slate-200 relative group">
                                                ...
                                                <div className="space-y-1.5">
                                                    <Label className="text-[10px] font-semibold text-slate-600">Improvement Plan / Notes</Label>
                                                    <textarea 
                                                        className="w-full min-h-[60px] bg-white border border-slate-200 rounded-md p-2.5 text-xs focus:ring-1 focus:ring-slate-900 outline-none resize-none"
                                            ...
                                            <Button 
                                                className="w-full h-9 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs tracking-wider rounded-md transition-all active:scale-95 disabled:opacity-50 mt-2"
                                        ...
                                        <div className="bg-emerald-50/50 border border-emerald-100 rounded-lg p-4 space-y-4">
                                            ...
                                            {selectedReport.resolutionSummary && (
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-xs text-emerald-900 bg-white p-2.5 rounded-md border border-emerald-100/50">
                                                        {selectedReport.resolutionSummary}
                                                    </p>
                                                </div>
                                            )}
