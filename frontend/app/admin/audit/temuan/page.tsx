        ...
        <div className="space-y-6">
            ...
            <Card className="bg-white dark:bg-slate-950 shadow-md border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
                <CardContent className="p-0">
                        ...
                        <Table className="min-w-full">
                            <TableHeader className="bg-slate-100/80 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-800">
                                <TableRow className="hover:bg-transparent">
                                    <TableHead className="w-[50px] font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 pl-5">No</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[130px]">Tanggal & Jam</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[180px]">Area / Tempat</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[150px]">Kategori 4M</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2">Deskripsi Temuan</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[110px]">Status</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2">Tindakan Perbaikan</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[140px]">Pelapor</TableHead>
                                    <TableHead className="font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 w-[90px]">Dok.</TableHead>
                                    <TableHead className="text-right font-bold text-slate-600 dark:text-slate-300 text-xs h-10 py-2 pr-5 w-[250px]">Aksi</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {loading ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={10} className="text-center py-12 text-slate-400 font-medium text-sm">
                                            Belum ada data temuan peduli bersinergi.
                                        </TableCell>
                                    </TableRow>
                                ) : (
                                    paginatedData.map((item, index) => (
                                        <TableRow key={item.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-900/50 transition-colors group">
                                            <TableCell className="py-3 pl-5 text-xs font-semibold text-slate-500 dark:text-slate-400">{(page - 1) * ITEMS_PER_PAGE + index + 1}</TableCell>
                                            <TableCell className="py-3">
                                                <div className="flex flex-col gap-0.5">
                                                    <span className="font-bold text-slate-800 dark:text-slate-100 text-xs">{formatDateDDMMM(item.tanggal)}</span>
                                                    <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">{item.jam}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell className="py-3">
                                                <div className="flex flex-col gap-0.5">
                                                    <span className="font-bold text-slate-800 dark:text-slate-100 text-xs truncate max-w-[160px]">{item.area}</span>
                                                    <span className="text-[10px] text-indigo-600 dark:text-indigo-400 font-medium truncate max-w-[160px]">{item.tempatTemuan}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell className="py-3">
                                            ...
                                            <TableCell className="py-3">
                                                <div className="text-xs text-slate-600 dark:text-slate-300 max-w-[200px] truncate font-medium" title={item.temuan}>
                                                    {item.temuan}
                                                </div>
                                            </TableCell>
                                            <TableCell className="py-3">
                                            ...
                                            <TableCell className="py-3">
                                                <div className="text-xs text-slate-600 dark:text-slate-300 max-w-[200px] truncate font-medium" title={item.tindakanPerbaikan}>
                                                    {item.tindakanPerbaikan || <span className="text-slate-400 italic font-normal">Belum ada tindakan...</span>}
                                                </div>
                                            </TableCell>
                                            <TableCell className="py-3">
                                            ...
                                            <TableCell className="py-3">
                                                <div className="flex flex-col gap-1 items-start">
                                                    ...
                                                    ) : <span className="text-slate-300 dark:text-slate-600 text-[10px] pl-2">-</span>}
                                                    {item.fotoPerbaikanUrls && item.fotoPerbaikanUrls.length > 0 && (
                                                        <Button variant="ghost" size="sm" onClick={() => viewPhotos(item.fotoPerbaikanUrls)} className="h-5 px-1.5 text-[9px] font-bold gap-1 text-emerald-600 bg-emerald-50 hover:bg-emerald-100 rounded mt-0.5">
                                            ...
                                            <TableCell className="text-right py-3 pr-5">
                                                <div className="flex justify-end gap-1.5">
                                                    <Button variant="outline" size="sm" className="h-7 px-2.5 text-[10px] font-bold rounded-md text-emerald-600 border-emerald-200 bg-emerald-50 hover:bg-emerald-100 hover:text-emerald-700 transition-colors shadow-sm" onClick={() => handleViewDetail(item)}>
                    ...
                    {/* Pagination Footer */}
                    <div className="flex flex-col md:flex-row items-center justify-between p-4 border-t border-slate-200 dark:border-slate-800 gap-4 bg-slate-50/50 dark:bg-slate-900/20">
                        ...
                        <div className="flex items-center gap-1 bg-white dark:bg-slate-900 p-1 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
                            <Button
                                ...
                                className="rounded-md h-7 w-7 p-0 disabled:opacity-30 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-slate-500 dark:text-slate-400"
                            >
                                ...
                                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                                    ...
                                    return (
                                        <Button
                                            ...
                                            className={`rounded-md h-7 w-7 font-bold text-[10px] min-w-[28px] p-0 transition-all ${page === pageNum ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                                        >
                                            {pageNum}
                                        </Button>
                                    );
                    ...
                    <div className="block md:hidden space-y-4 p-4 bg-slate-50/50 dark:bg-slate-900/30">
                        {loading ? (
                            ...
                            <div className="text-center py-10 text-slate-400 text-xs border rounded-xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
                                Belum ada data temuan.
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {paginatedData.map((item, index) => (
                                    <div key={item.id} className="bg-white dark:bg-slate-950 rounded-xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col">
                                        {/* Mobile Card Header */}
                                        <div className="bg-slate-50/80 dark:bg-slate-900/80 px-3 py-2.5 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                                            <div className="flex items-center gap-2 overflow-hidden">
                                                {getStatusBadge(item.status)}
                                                <div className="flex flex-col">
                                                    <span className="font-bold text-slate-800 dark:text-slate-100 text-[11px] truncate max-w-[150px]">{item.area}</span>
                                                    <span className="text-indigo-600 dark:text-indigo-400 text-[9px] font-semibold truncate max-w-[150px]">{item.tempatTemuan}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="p-3 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                {(item.tindakanPerbaikan || item.status !== 'OPEN') && (
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <p className="text-[10px] text-emerald-700 dark:text-emerald-400 font-medium line-clamp-2">
                                                            {item.tindakanPerbaikan || <span className="italic opacity-60 text-slate-400">Proses perbaikan...</span>}
                                                        </p>
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-800 mt-2">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 truncate max-w-[80px]">
                                                        {item.user ? `${item.user.firstName} ${item.user.lastName}` : item.diInputOleh}
                                                    </span>
                                                </div>
